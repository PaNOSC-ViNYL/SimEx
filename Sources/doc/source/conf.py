# -*- coding: utf-8 -*-
#
# simex_platform documentation build configuration file, created by
...
sys.path.insert(1,os.path.abspath(os.path.join(os.path.dirname(__file__),'..','..','python','SimEx')))
...
htmlhelp_basename = 'simex_platformdoc'
