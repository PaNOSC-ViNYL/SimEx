...
class PlasmaXRTSCalculator(AbstractPhotonDiffractor):
    ...
    def __init__(self,  parameters=None, input_path=None, output_path=None):
        ...
        <br/><b>type</b> : AbstractCalculatorParameters

        @param input_path Path to the input data for this calculator.
        <br/><b>type</b> str

        @param ouput_path Where to write output data generated by this calculator.
        <br/><b>type</b> str
        <br/><b>default</b> 'xrts_out.h5'
        """
...
def extractDate(pattern_string, text):
    ...
    <br/><b>type</b> str (argument to re.compile)
