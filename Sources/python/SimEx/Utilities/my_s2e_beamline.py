...
def get_beamline():
    ...
    hfm    = wpg.optical_elements.Mirror_elliptical( orient='x',p=distance, q=(distance_hfm_vfm+distance_foc),
    ...
    defineOPD(wf_dist_om, os.path.join(mirror_data_dir,'mirror2.dat'), 2, '\t', 'x',
              theta_kb, scale=MIRROR_PROFILE_SCALE)
    # if isIpynb:
    ...
    defineOPD(wf_dist_hfm, os.path.join(mirror_data_dir,'mirror1.dat'), 2, '\t', 'x',
              theta_kb, scale=MIRROR_PROFILE_SCALE, stretching=kb_mirror_length/0.8)
    # if isIpynb:
