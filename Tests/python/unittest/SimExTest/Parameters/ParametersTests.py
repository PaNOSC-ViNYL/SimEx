...
from .IonMatterInteractorParametersTest import IonMatterInteractorParametersTest
...
def suite():
    suites = [
             ...
             unittest.makeSuite(GaussWavefrontParametersTest,               'test'),
             ...
             unittest.makeSuite(IonMatterInteractorParametersTest,       'test'),
             ]
